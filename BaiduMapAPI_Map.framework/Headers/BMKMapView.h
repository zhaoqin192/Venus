 ...
 * @param bShow 是否显示
 */
- (void)setBaseIndoorEnabled:(bool)bShow;
 ...
 *        strID         室内图ID
 */
- (void)switchBaseIndoorMapFloor:(NSString*)strFloor withID:(NSString*)strID;
 ...
 *@param info 室内图信息
 */
- (void)BaseIndoorMapMode:(BMKMapView *)mapView withIn:(BOOL)nFlag withInfo:(BMKBaseIndoorMapInfo* )info;
